  ...
  return (
    <div className="flex flex-col items-end mb-4 relative group">
      <div className="max-w-[85%] bg-[#dcf8c6] rounded-2xl rounded-tr-sm p-2 shadow-sm relative">
        ...
        <button 
          onClick={toggleMenu} 
          className="absolute -top-2 -right-2 bg-white p-1 rounded-full shadow-sm z-20 border border-gray-100 text-gray-500 hover:text-gray-800 transition-colors"
        >
...
// ---------- Updated Preview Modal with Clean Labels ----------
      ...
      <div className="flex justify-between items-center mb-6 sticky top-0 bg-[#efeae2] py-2 z-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="bg-red-50 text-red-600 px-3 py-1.5 rounded-full text-sm font-semibold shadow-sm border border-red-200 hover:bg-red-100 transition-colors flex items-center gap-1"
          >
            <LogOut size={16} />
            Logout
          </button>
